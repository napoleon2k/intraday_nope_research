...
for index, row in df.iterrows():
    ...
    if index == 0:
        ...
        df.at[index, "corrdN_sub_dN2_lag_2"] = stats.spearmanr(dN_sub_dN2, dPriceLag2)[
            0
        ]
...
axs[0].plot(
    df["timestamp"], df["corrLag"], "orange", label="Cor(dNope(T), dPrice(T+5))"
)
axs[0].plot(
    df["timestamp"], df["corrLag_2"], "red", label="Cor(dNope(T), dPrice(T+10))"
)
...
axs[1].plot(
    df["timestamp"], df["corrD2Lag"], "blue", label="Cor(dNope2(T),dPrice(T+5))"
)
axs[1].plot(
    df["timestamp"], df["corrD2Lag_2"], "green", label="Cor(dNope2(T),dPrice(T+10))"
)
...
axs[2].plot(
    ...
    df["corrdN_sub_dN2"],
    "green",
    label="Cor((dNope - est_dNope2)(T) , dPrice(T))",
)
axs[2].plot(
    df["timestamp"],
    df["corrdN_sub_dN2_lag"],
    "red",
    label="Cor((dNope - est_dNope2)(T) , dPrice(T+5))",
)
axs[2].plot(
    df["timestamp"],
    df["corrdN_sub_dN2_lag_2"],
    "blue",
    label="Cor((dNope - est_dNope2)(T) , dPrice(T+10))",
)
